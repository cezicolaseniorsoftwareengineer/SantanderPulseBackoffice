...
@Component({
  ...
  `,
  styles: [`
    /* ====== OVERLAY & CONTAINER - Padrão Modal ====== */
    ...
    /* ====== HEADER - Separação de responsabilidades visuais ====== */
    .form-header {
      display: flex;
      align-items: center;
    ...
    /* ====== FORM CONTENT - Organização semântica ====== */
    .santander-form {
      padding: 32px;
    }
    ...
    /* ====== INPUTS - Estado e feedback visual ====== */
    .form-label {
      font-size: 14px;
      font-weight: 600;
      color: #2d3748;
    ...
    /* ====== ACTIONS - Command pattern visual ====== */
    .form-actions {
      display: flex;
      gap: 16px;
